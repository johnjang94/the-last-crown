...
const vi: T = {
  ...
  writingRound: "Đang chuẩn bị vòng đấu",
  creatingImages: (done, total) => `Đang chuẩn bị hình ảnh (${done} / ${total})`,
  preparingVisual: "Đang chuẩn bị hình ảnh…",
  startGame: "Bắt đầu trò chơi",

  passage: "Đoạn văn",
  roundNotesTitle: "Lưu ý vòng đấu",
  note1: "Tất cả đoạn văn và hình ảnh trong vòng này được chuẩn bị cho phiên chơi hiện tại.",
  ...
  crownedThisRound: "Vương miện vòng này",
  winningScore: "Điểm chiến thắng",
  scoreGap: "Khoảng cách điểm",
  finalStandings: "Xếp hạng chung cuộc",
  yourRound: "Vòng đấu của bạn",
  personalSummaryWon: "Bạn đã đứng đầu và giành lấy vương miện.",
  personalSummaryLost: "Bạn đã bám đuổi đến tận lần lật mở cuối cùng.",
  yourScore: "Điểm của bạn",
  solutionLabel: "Đáp án",
  ...
  howToPlayDesc1: "Bạn có thể chơi một mình, với người chơi trực tuyến khác, hoặc chơi theo nhóm. Đây là bước chọn chế độ.",
  soloCardTitle: "Solo",
  ...
  howToPlayDesc4: "Sau khi chọn chế độ, loại trò chơi và độ khó, trò chơi bắt đầu. Các đoạn văn và hình ảnh được chuẩn bị cho mỗi vòng.",
  readyTitle: "Sẵn sàng",
  readyDesc: "Khi đã hiểu cách chơi, quay về trang chủ và tạo phòng.",
  tutorialLibraryTitle: "Cách chơi",
  tutorialLibraryDesc: "Chọn một loại trò chơi để xem nhanh cách vận hành trước khi bắt đầu.",
  tutorialAutoTitle: "Lần đầu ở chế độ này",
  tutorialAutoDesc: "Đây là phần giới thiệu ngắn để bạn vào nhịp ngay.",
  tutorialGoalLabel: "Mục tiêu",
  tutorialHowItWorksLabel: "Cách hoạt động",
  tutorialTipLabel: "Điều cần chú ý",
  tutorialScoringLabel: "Tính điểm",
  tutorialOpenGenre: "Mở hướng dẫn",
  tutorialStart: "Bắt đầu vòng",
  tutorialContinue: "Đã hiểu",
  settingsMenu: "Cài đặt",
  openSettings: "Cài đặt trò chơi",
  openHowToPlay: "Cách chơi",

  genreRiddles: "Câu đố",
  genreRiddlesDesc: "Đọc gợi ý, thảo luận về tình tiết, và đoán câu trả lời ẩn.",
  genreGuess: "Lựa chọn cuối",
  genreGuessDesc: "Theo dõi câu chuyện, thử từng phương án và chốt đáp án cuối cùng vẫn khớp với mọi manh mối.",
  genreVisualMatch: "Khớp hình ảnh",
  genreVisualMatchDesc: "So sánh góc nhìn mê cung 3D với bản đồ mê cung 2D có nhãn.",
  genreNumberToLetter: "Phá mã",
  genreNumberToLetterDesc: "Phá quy luật ẩn trong đề bài và chọn đáp án sống sót sau lớp mật mã.",
...
const hi: T = {
  ...
  writingRound: "राउंड तैयार किया जा रहा है",
  creatingImages: (done, total) => `दृश्य तैयार किए जा रहे हैं (${done} / ${total})`,
  preparingVisual: "दृश्य तैयार हो रहा है…",
  startGame: "खेल शुरू करें",

  passage: "अनुच्छेद",
  roundNotesTitle: "राउंड नोट्स",
  note1: "इस राउंड के सभी अनुच्छेद और दृश्य इसी गेम सत्र के लिए तैयार किए गए हैं।",
  ...
  winner: "विजेता",
  newGame: "नया खेल",
  crownedThisRound: "इस राउंड का ताज",
  winningScore: "जीत का स्कोर",
  scoreGap: "स्कोर का अंतर",
  finalStandings: "अंतिम रैंकिंग",
  yourRound: "आपका राउंड",
  personalSummaryWon: "आप सबसे ऊपर रहे और ताज जीत लिया।",
  personalSummaryLost: "आप अंतिम खुलासे तक मुकाबले में बने रहे।",
  ...
  howToPlayDesc1: "आप अकेले, अन्य ऑनलाइन खिलाड़ियों के साथ, या ग्रुप में खेल सकते हैं। यह मोड चयन का चरण है।",
  soloCardTitle: "सोलो",
  ...
  howToPlayDesc4: "मोड, गेम टाइप और कठिनाई चुनने के बाद, खेल शुरू हो जाता है। अनुच्छेद और दृश्य उस राउंड के लिए तैयार किए जाते हैं।",
  readyTitle: "तैयार",
  readyDesc: "जब आप सेटअप समझ लें, तो होम पर वापस जाएं और कमरा बनाएं।",
  tutorialLibraryTitle: "कैसे खेलें",
  tutorialLibraryDesc: "शुरू करने से पहले किसी गेम टाइप को चुनकर उसका छोटा गाइड देखें।",
  tutorialAutoTitle: "इस गेम टाइप में पहली बार",
  tutorialAutoDesc: "यह छोटा गाइड राउंड को शुरुआत से ही स्पष्ट बना देगा।",
  tutorialGoalLabel: "लक्ष्य",
  tutorialHowItWorksLabel: "यह कैसे चलता है",
  tutorialTipLabel: "क्या देखना है",
  tutorialScoringLabel: "स्कोरिंग",
  tutorialOpenGenre: "गाइड खोलें",
  tutorialStart: "राउंड शुरू करें",
  tutorialContinue: "समझ गया",
  settingsMenu: "सेटिंग्स",
  openSettings: "गेम सेटिंग्स",
  openHowToPlay: "कैसे खेलें",

  genreRiddles: "पहेलियां",
  genreRiddlesDesc: "संकेत पढ़ें, मोड़ पर चर्चा करें, और छिपा उत्तर ढूंढें।",
  genreGuess: "फाइनल पिक",
  genreGuessDesc: "कहानी को सुनें, विकल्पों को परखें, और वही अंतिम चयन करें जो हर संकेत पर खरा उतरता हो।",
  genreVisualMatch: "विज़ुअल मैच",
  genreVisualMatchDesc: "3D भूलभुलैया दृश्य को लेबल वाले 2D मानचित्र से मिलाएं।",
  genreNumberToLetter: "कोडब्रेकर",
  genreNumberToLetterDesc: "प्रॉम्प्ट में छिपे कोड को तोड़ें और वही उत्तर चुनें जो पैटर्न के बाद भी सही बचे।",
